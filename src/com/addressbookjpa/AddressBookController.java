...
public class AddressBookController {
    ...
    private final EntityManagerFactory entityManagerFactory = 
            Persistence.createEntityManagerFactory("AddressBookJPAPU");
    ...
    public void initialize() {
        listView.setItems(contactList); // bind to contactList
        ...
        getAllEntries(); // populates contactList, which update listView*/
    }
    ...
    void findButtonPressed(ActionEvent event) {
        ...
        TypedQuery<Addresses> findByLastname = 
                entityManager.createNamedQuery("Addresses.findByLastname", Addresses.class);
